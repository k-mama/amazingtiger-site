...
const enGB: Dictionary = {
  ...
  dashboard: {
    ...
    loggedOut: {
      ...
      lead: "Sign in to view your membership status, studio letters, and consultation history.",
      cta: "Sign In",
    },
    loggedIn: {
    ...
    cards: [
      { title: "Private Reading Room", description: "Coming soon — early manuscripts and selected releases for members." },
      { title: "Studio Letters", description: "Coming soon — notes from the studio, sent to members first." },
      { title: "Consultation History", description: "Coming soon — a record of your consultation requests and replies." },
      { title: "Future Orders", description: "Coming soon — orders and collector editions, once the shop connects." },
    ],
  ...
  admin: {
    ...
    orders: {
      ...
      statusLabels: {
        pending_inquiry: "Pending Enquiry",
        pending: "Pending",
        paid: "Paid",
        fulfilled: "Fulfilled",
        cancelled: "Cancelled",
