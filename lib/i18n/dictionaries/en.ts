...
const en: Dictionary = {
  ...
  cart: {
    ...
    checkoutNote: "This sends a private order request, not a payment. We will contact you to confirm availability and complete checkout.",
    requestCheckout: "Request private checkout",
    consultationFallback: "Ask through consultation instead",
    close: "Close",
    open: "Open private cart",
    orderRequest: {
      heading: "Private Order Request",
      lead: "Share a few details and we will confirm availability and checkout with you personally.",
      selectedObjectsHeading: "Selected Objects",
      nameLabel: "Full Name",
      emailLabel: "Email",
      countryLabel: "Country",
      regionLabel: "City or Region",
      messageLabel: "Message (optional)",
      submit: "Send Private Order Request",
      submitting: "Sending…",
      back: "Back to cart",
      retry: "Try again",
      successHeading: "Request Received",
      successMessage: "Your private order request has been received. We will contact you with availability and checkout details.",
