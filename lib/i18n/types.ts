...
export interface Dictionary {
  ...
  projectBornRarePage: {
    ...
    questionBody: string[];
    northStarHeading: string;
    northStarLines: string[];
    architectureHeading: string;
    architectureItems: { title: string; description: string }[];
    sceneHeading: string;
    sceneIntro: string[];
    sceneObjects: { object: string; description: string }[];
    voiceHeading: string;
    voiceBody: string[];
    principlesHeading: string;
    principles: string[];
    worldHeading: string;
    worldItems: { title: string; description: string }[];
    notDoingHeading: string;
