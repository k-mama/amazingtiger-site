...
components/               Header, Footer, LanguageSwitcher, HomeContent, ProductCard, ProductDetail,
                           ...
                           (cart + private order request form), useCart,
